<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <textarea wire:model="descripcion" id="descripcion" placeholder="Descripcion general de la vacante"
    ...
    <div>
        ...
        <div class="my-5 w-80">
            ...
            <img class="img-fluid" src="{{asset('storage/vacantes/'. $imagen)}}" alt="{{'imagen vacante ' . $titulo}}">
        </div>
        <div class="my-5 w-80 object-center">
